...
const CONFIG = {
    ...
    metrics: {
        ...
        udaan_savings:         'ROI +7% (demand forecasting & inventory models)',
        fulfillment_rate:      '99.3%',
        zomato_market_share:   '+9%',
        fraud_tps:             '100+ TPS at sub-ms P99',
        portfolio_analytics:   'in progress - Kafka to Spark shipped, FastAPI/Streamlit falls back to generated data',
