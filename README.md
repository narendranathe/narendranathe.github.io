...
AI workflow automation platform: Chrome MV3 + FastAPI connecting job discovery, document tailoring, form-state management, LLM routing, and application tracking. 355 backend tests, 40+ endpoints, 11 ATS adapters, 7-page dashboard. Private deployment on Fly.io; public launch gated by tracked security fixes.
